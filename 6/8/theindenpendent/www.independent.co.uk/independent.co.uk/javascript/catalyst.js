...
s.linkInternalFilters="javascript:,.independent.co.uk"
...
function s_doPlugins(s) {
  ...
  /* Set Time Parting Variables - GMT */
	if(!s.prop8&&!s.eVar8) s.prop8=s.eVar8=s.getTimeParting('h','0'); // Set hour 
	if(!s.prop9&&!s.eVar9) s.prop9=s.eVar9=s.getTimeParting('d','0'); // Set day 
	if(!s.prop10&&!s.eVar10) s.prop10=s.eVar10=s.getTimeParting('w','0'); // Set weekday 
...
/*
/*	return the value for the auto refresh
*/
s.prop5=s.getQueryParam('CMP');
/*
...
//uncomment the next line upon cert purchase and integration
//s.trackingServerSecure="sc2.independent.co.uk"
